...
write.csv(output, "output_fix_easy.csv")
saveRDS(cm_results, "cm_results_fix_easy.rds")
saveRDS(param_results, "param_results_fix_easy.rds")

cat("Wrote output_fix_easy.csv, cm_results_fix_easy.rds, param_results_fix_easy.rds\n")
