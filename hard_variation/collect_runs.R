...
write.csv(output, "output_fix_hard.csv")
saveRDS(cm_results, "cm_results_fix_hard.rds")
saveRDS(param_results, "param_results_fix_hard.rds")

cat("Wrote output_fix_hard.csv, cm_results_fix_hard.rds, param_results_fix_hard.rds\n")
